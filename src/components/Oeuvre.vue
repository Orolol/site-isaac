  ...
  <div>
      ...
      >
        ...
        <div class="oeuvre-oeuvre">
          ...
          >
            ...
            <img
              class="img"
              :src="require(('@/assets/oeuvre/' +cat+'/'+ type+'/' + assets[0].filename + '-th.jpg'))"
            />
          </div>
    ...
    <transition name="fade">
      <div
        class="slideshow"
        v-if="slideshow"
        v-shortkey="['arrowup', 'arrowdown']"
        @shortkey="slideshow = false"
      >
        ...
        > <span class="symbol-prev">
            ...
            >
              <img
                class="img-slide"
                @click="next"
                :src="require('@/assets/oeuvre/' +cat+'/'+ type+'/' + assets[slideshowCurrent].filename  + '.jpg'
                )"
              />
        ...
        <div
          ...
          @shortkey="next"
        > <span class="symbol-next"> > </span> </div>
...
export default {
  ...
  methods: {
    ...
    next() {
      this.slideshowCurrent == datajson[this.cat].assets[this.type].length - 1
        ? (this.slideshowCurrent = 0)
